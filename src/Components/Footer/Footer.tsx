    ...
    <VStack w="30%" h="100%">
      ...
      <Box pt="30px" h="auto" w="100%" mt="5px" bgColor="#f7f7f7">
        ...
        <Flex p="20px" justify={"center"} gap="5px" flexWrap={"wrap"}>
          <Image src="https://images.dailyobjects.com/marche/icons/payments/amex-update.png?tr=cm-pad_resize"></Image>
          <Image src="https://images.dailyobjects.com/marche/icons/payments/maestro-update.png?tr=cm-pad_resize"></Image>
          <Image src="https://images.dailyobjects.com/marche/icons/payments/mastercard-update.png?tr=cm-pad_resize"></Image>
          <Image src="https://images.dailyobjects.com/marche/icons/payments/mobikwik-update.png?tr=cm-pad_resize"></Image>
          <Image src="https://images.dailyobjects.com/marche/icons/payments/paytm-update.png?tr=cm-pad_resize"></Image>
          <Image src="https://images.dailyobjects.com/marche/icons/payments/rupay-update.png?tr=cm-pad_resize"></Image>
          <Image src="https://images.dailyobjects.com/marche/icons/payments/upi-update.png?tr=cm-pad_resize"></Image>
          <Image src="https://images.dailyobjects.com/marche/icons/payments/visa-update.png?tr=cm-pad_resize"></Image>
        </Flex>
      </Box>
    </>
  );
